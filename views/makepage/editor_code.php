...
<script>
	...
	function get_con(){
		...
		//alert(con);
		$('#con_html',parent.document).val(con);
		//parent.update_code();
		//alert(con);
	}

    function set_con(){
        var con = $('#con_html',parent.document).val();
        editor.setValue(con);
    }
	...
	function check_value(){
		...
		var origin_value = $('#con_html',parent.document).val();


		var value_load_check = $('#value_load_check',parent.document).val();

		editor.setValue(origin_value);
		var editor_value = editor.getValue();

		if(value_load_check=='done'){
