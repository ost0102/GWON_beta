		  ...
		  if(!pop_id){
		  	...
		  	if(datepicker2<datepicker1){
			   ...
			   function(data){
				 ...
				 $('#popup_con_txt').html('');
				 $('#popup_txt').html('');
				 location.href='/openpage/popup_noti/'+page_secur+'_'+pop_id;
			   });
		  	}
		  }
		});
...
<div id='container'>
	...
	<div id='popup_area'>
		<h1>팝업 등록하기</h1>
		<div id='popup_con'>
			<input  type="hidden" id="pop_id" style="width: 200px; margin-top:10px;" value='<? if(isset($pop_id)){ echo $pop_id; }?>'/>
			...
			<div id='popup_con_txt' style="display: none;"><?if(isset($pop_con))echo $pop_con;?></div>
			...
			<div id='popup_bt_area'>
				...
				<br/>
				시작일 : <input  type="text" id="datepicker1" style="width: 200px; margin-top:10px;" value='<?echo $s_date;?>'/>&nbsp;&nbsp;
				종료일 : <input  type="text" id="datepicker2" style="width: 200px; margin-top:10px;" value='<?echo $f_date;?>'/><br/>
				<hr style='margin-bottom: 10px;'/>
				<button id="edit_popup" class="btn btn-info" style='float: right;'><img src='/img/icon/icon_save_w.png' style='width:16px; margin-right: 5px;' valign='middle'>저장</button>
			</div>
		</div>
	</div>
	<!-- popup Area finish -->
