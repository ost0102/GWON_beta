...
<script type="text/javascript">
	...
	function show_apply_data(domain){
		window.open('/apply/show_apply_info/'+domain,'','width=500, height=450');
	}
	//pdf 보기
	function show_apply_pdf(domain){
		window.open('/apply/show_apply_info_pdf/'+domain,'','width=500, height=450');
	}
</script>
</head>
<body>
			...
			<div id='main_con_right' style='margin-top: 0px;'>
				...
				<div class='main_con_right_w con_outline'>
					...
					<div class='mypage_con_list'>
			                        ...
			                        if(isset($user_apply_info)&&$user_apply_info!=''){
			                            foreach ($user_apply_info as $my_apply_info)
			                            {

			                                $w_num = $my_apply_info['w_num'];
			                                $page_secur = $my_apply_info['page_secur'];
			                                $title = $my_apply_info['title'];
			                                $domain = $my_apply_info['domain'];
			                                $date = $my_apply_info['date'];
			                                ?>
			                                <!--item 영역-->
							...
							<div class='work_item_link_area'>
								...
								<div class='work_item_con2'>
									<a href="javascript:show_apply_data('<?echo $domain;?>');">
									    <span style='font-size: 12px;'>
									        신청 내용 보기
									    </span>
									</a>
									&nbsp;|&nbsp;
									<a href="javascript:show_apply_pdf('<?echo $domain;?>');">
									    <span style='font-size: 12px;'>
									        PDF보기
									    </span>
									</a>
